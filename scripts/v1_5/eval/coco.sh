...
MODEL_NAME="opt-125m-CrossAttR15"
python llava/eval/model_caption.py \
    --model_path "./checkpoints/LM-2e5/${MODEL_NAME}/checkpoint-25000" \
    --version opt
python llava/eval/model_caption.py \
...
MODEL_NAME="opt-125m-percR2H512"
python llava/eval/model_caption.py \
    --model_path "./checkpoints/LM-2e5/${MODEL_NAME}/checkpoint-25000" \
    --version opt
python llava/eval/model_caption.py \
...
MODEL_NAME="opt125-4MLP4E-ViBs2"
python llava/eval/model_caption.py \
    --model_path "./checkpoints/LM-2e5/${MODEL_NAME}/checkpoint-25000" \
    --version opt
python llava/eval/model_caption.py \
...
MODEL_NAME="opt125-4MLP4E-ViBs3"
python llava/eval/model_caption.py \
    --model_path "./checkpoints/LM-2e5/${MODEL_NAME}/checkpoint-25000" \
    --version opt
python llava/eval/model_caption.py \
